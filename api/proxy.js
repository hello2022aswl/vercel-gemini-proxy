...
// Export for Cloudflare Workers (保持兼容性)
export const cloudflareWorker = { fetch: handleRequest };

// Export for Cloudflare Pages Functions (保持兼容性)
